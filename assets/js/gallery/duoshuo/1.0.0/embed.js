	...
	w.require("jQuery", function () {
			...
			this.delegate("a.ds-post-likes", "click", function (e) {
				...
				if (n.attr("data-root-id") == 0) {
					...
					o[0] ? o.remove() : (o = i('<ul class="ds-children"></ul>').insertAfter(n), L("/api/posts/listComments", bt({
							...
							l(e),
							o.append(i.map(e.response, function (e) {
									return J.post(e, t)
								}).join(""))
						}))
				}
					...
					Y = setTimeout(function () {
							...
							try {
								if (r.hasClass("ds-comment-context"))
									...
									ut[f] ? G.html(J.userInfo(ut[f].data)) : L("/api/users/profile", bt(a), function (e) {
										var t = e.response;
		...
		H.Replybox.prototype = {
			render : function (e) {
				...
				var C = function (e) {
					T(f),
					A("/api/posts/create", i.extend(w.toJSON(f), e), function (e) {
						var t = e.response,
						i = dt(n.postList, t, s);
				...
				i(l).change(function () {
					var e = this.checked;
					c[e ? "removeClass"
						 : "addClass"]("ds-service-icon-grey")[e ? "addClass" : "removeClass"]("ds-service-icon"),
		...
		H.Dialog = Z.extend({
				...
				open : function () {
					...
					e.el.show().find(".ds-dialog").delegate("a.ds-dialog-close", "click", function (t) {
						return e.close(),
						!1
					}).click(h);
					var n = function (t) {
		...
		H.EmbedThread = R.extend({
				...
				onload : function (t) {
					...
					r.updateCounter(),
					t.alerts && i.each(t.alerts, function (e, t) {
